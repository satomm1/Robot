...
#include "terminal.h"
/*----------------------------- Module Defines ----------------------------*/
#define BAUD_CONST 129// 42 // sets up baud rate for 115200
...
//#define USE_RB2_3
  ...
  // as analog inputs
  ANSELA &= (BIT4LO);  // clear analog control
  LATBbits.LATB4 = 1;           // start with TX high
  TRISBbits.TRISB4 = 0;         // set RB7 as output
  TRISAbits.TRISA4 = 1;         // set RB6 as input
  RPB4R = 0b0001;               // map U1TX -> RB4
  U1RXR = 0b0010;               // map U1RX <- RA4
#endif  //USE_RB2_3
