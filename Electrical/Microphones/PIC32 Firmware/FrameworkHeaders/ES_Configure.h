...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "MicrophoneFSM.h"
// the name of the Init function
#define SERV_2_INIT InitMicrophoneFSM
// the name of the run function
#define SERV_2_RUN RunMicrophoneFSM
// How big should this services Queue be?
...
#define TIMER13_RESP_FUNC PostLedFSM
#define TIMER14_RESP_FUNC PostMicrophoneFSM
